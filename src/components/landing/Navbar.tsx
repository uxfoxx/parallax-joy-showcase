...
const Navbar = () => {
  ...
  // `isDark` tracks the section underneath the navbar. The bar *matches*
  // it — dark section → near-black bar, light section → light bar — as a
  // frosted glass strip spanning edge-to-edge.
