    ...
    <PageLayout>
      <section className="relative overflow-hidden py-10 lg:py-14">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="font-display text-2xl md:text-3xl font-bold text-primary-foreground mb-2">{showOurProducts ? "Our Products" : "All Products"}</motion.h1>
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15, duration: 0.5 }} className="font-body text-sm text-primary-foreground/70 max-w-xl mx-auto">{showOurProducts ? "Our curated selection of premium food products for the Sri Lankan market." : "Browse our complete catalog of premium food imports from around the world."}</motion.p>
        </div>
      </section>
