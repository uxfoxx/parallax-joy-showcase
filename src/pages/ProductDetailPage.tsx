...
const ProductDetailPage = () => {
  ...
  const relatedProducts = product
    ? getProductsByBrand(product.brandSlug).filter((p) => p.id !== product.id).slice(0, 3)
    : [];
    ...
    return (
      <PageLayout>
        <div className="py-40 text-center">
          ...
          <Link to="/products" className="font-body text-forest-mid hover:underline">
            ← Back to Products
          </Link>
        </div>
      </PageLayout>
      ...
      <section className="py-12 bg-background">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <motion.div
            ...
            className="flex items-center gap-2 text-sm font-body text-muted-foreground mb-10"
          >
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <motion.div
              ...
              className="rounded-3xl bg-gradient-to-br from-forest-deep/10 via-forest-mid/5 to-accent/10 aspect-square flex items-center justify-center"
            >
              <span className="font-display text-8xl text-forest-mid/15 font-bold">
            ...
            >
              <div className="space-y-3">
                <Badge variant="outline" className="font-body text-xs border-border text-foreground">
                  {product.category}
                </Badge>
                ...
                <Link
                  ...
                  className="inline-block font-body text-forest-mid font-medium hover:underline"
                >
