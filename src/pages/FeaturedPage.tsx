    ...
    <PageLayout>
      <section className="relative overflow-hidden py-28 lg:py-36">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="font-display text-4xl md:text-6xl font-bold text-primary-foreground mb-6">Featured Products</motion.h1>
